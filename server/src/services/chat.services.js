...
export class ChatService {
  ...
  async createConversation( userId , mode = "chat", title = null) {
    ...
    if (!prisma || !prisma.conversation) {
      console.error("[DEBUG] Prisma client keys:", prisma ? Object.keys(prisma) : prisma);
      throw new Error("Prisma client missing 'conversation' delegate. Run 'npx prisma generate' and ensure @prisma/client matches schema.");
    }
